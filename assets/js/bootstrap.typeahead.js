...
!function($){
    ...
    Typeahead.prototype = {
        ...
        , select: function () {
            ...
            this.$element
                .val(this.$element.val().substring(0,this.$element.val().lastIndexOf("@")+1)+this.updater(val)+" ")
                .change()
            return this.hide()
        }
        ...
        , lookup: function (event) {
            ...
            var chars = this.query.match(/(.+)?@(.+)$|@(.+)$/);

            if (chars == null || !this.query || this.query.length < this.options.minLength) {
                return this.shown ? this.hide() : this
            }
            this.query = chars[2] ? chars[2] : '';
